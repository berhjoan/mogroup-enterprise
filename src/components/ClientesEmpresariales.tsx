...
export default function ClientesEmpresariales() {
  const clientes = [
  ...
  return (
    <section className="py-16 bg-gray-50">
      <div className="max-w-7xl mx-auto px-6">
        <h2 className="text-4xl font-bold text-center mb-4">Nuestros Clientes Empresariales</h2>
        <p className="text-center text-gray-600 mb-12">Empresas líderes en Panamá confían en MOGROUP para sus operaciones</p>
